...
void blib::graphics::Romb::setPosition(const Vector3f& _position)
{
    this->transform.position = _position;
}

blib::graphics::Vector3f blib::graphics::Romb::getPosition() const
{
    return this->transform.position;
}

void blib::graphics::Romb::setRotation(const Vector3f& _rotation)
{
    this->transform.rotation = _rotation;
}

blib::graphics::Vector3f blib::graphics::Romb::getRotation() const
{
    return this->transform.rotation;
}

void blib::graphics::Romb::setScale(const Vector3f& _scale)
{
...
blib::graphics::Vector3f blib::graphics::Romb::getScale() const
{
    return this->transform.scale;
}

void blib::graphics::Romb::setOrigin(const Vector3f& _origin)
{
...
blib::graphics::Vector3f blib::graphics::Romb::getOrigin() const
{
    return this->transform.origin;
}

void blib::graphics::Romb::Move(const Vector3f& _position)
{
    this->transform.position += _position;
}

void blib::graphics::Romb::Rotate(const Vector3f& _rotatation)
{
