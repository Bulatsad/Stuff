#!/bin/sh
# Сборка ядра Stuff (Release): blib-system, blib-core и их тесты,
# затем прогон тестов.
...
cmake -S src -B linuxbuild -DCMAKE_BUILD_TYPE=Release \
    -DBUILD_TESTS=ON \
...
cmake --build linuxbuild --config Release --target blib-system blib-core blib_tests
